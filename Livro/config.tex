...
% \usepackage[pages=all]{background}  % removido: \backgroundsetup está comentado,
%   mas [pages=all] ainda hookava cada página, custando tempo de compilação.
...
\newfontfamily\baskerfamily[Path=Fonts/, Extension=.ttf]{BASKER}
\newfontfamily\ringmfamily[Path=Fonts/, Extension=.ttf]{RINGM}
...
\setmainfont[Path=Fonts/, Extension=.ttf]{BASKER}

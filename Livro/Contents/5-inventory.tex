...
Os pesos desta seção são os mesmos usados na tabela de Armaduras e Proteções. O peso da armadura conta normalmente contra a Carga, mesmo quando o personagem não cumpre o requisito necessário para utilizá-la.

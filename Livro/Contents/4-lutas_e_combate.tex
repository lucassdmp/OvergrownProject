...
O \textbf{MOD de Atributo não participa do teste de ataque}. Expressões como \textbf{MOD de MIG}, \textbf{MOD de GRA} ou \textbf{MOD de WIS} presentes na ficha da arma ou da magia são somadas somente ao dano, depois de confirmar o acerto. Por exemplo, uma arma com dano \textbf{2D6 + MOD de MIG} testa o acerto usando a reserva indicada + Luta; ao acertar, causa 2D6 + MOD de MIG.
...
\begin{description}
    \item[\ringm{Arcos}:] Arcos são excelentes condutores de energia primordial. Ao canalizar uma magia através de um arco, o conjurador dispara a magia como se fosse uma flecha. O ataque utiliza o \link{stats:crit}{Nível de Ameaça} do arco e seus bônus de distância. A magia herda o tipo de dano definido pelo conjurador. Por continuar sendo uma magia, o teste soma \textbf{Arcanismo}, mas utiliza \textbf{Grace} para determinar a reserva de d20 no lugar de Wisdom.

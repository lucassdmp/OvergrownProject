...
O Modificador de Iniciativa é baseado na \\link{att:grace}{Grace} do personagem, onde cada 5 pontos de graça concedem um bonus de +1 na iniciativa. Por exemplo, um personagem com 12 de Graça teria um Modificador de Iniciativa de +2.
\end{rpgboxtips}

...
\combatSkill{Pontos Fatais}{3}{Gaste sua \textbf{Reação} para realizar um teste de \link{per:discernimento}{Discernimento} contra a DT do alvo. Ao passar, você identifica uma abertura em suas defesas, reduzindo sua \textbf{RD apenas para os seus ataques}. Se a redução ultrapassar a RD total, você também ganha \textbf{+2 na Margem de Ameaça} contra esse alvo.}
...
\combatSkill{Postura de Muralha}{1 por rodada}{Você não pode atacar, mas \textbf{dobra sua Armadura} até o início do seu próximo turno. Uma defesa impenetrável para quem sabe que o maior dano é o recebido.}

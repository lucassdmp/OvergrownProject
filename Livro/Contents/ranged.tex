...
\combatSkill{Ponto Cego}{2}{Ao atacar um alvo que está \textbf{engajado em combate corpo a corpo com um aliado}, você gasta PC para encontrar uma brecha. O ataque \textbf{ignora a Esquiva} do alvo (apenas a armadura base é aplicada) e \textbf{elimina o risco de acertar seu aliado}.}

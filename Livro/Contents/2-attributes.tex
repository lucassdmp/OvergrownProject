...
Resistência é um atributo passivo: ela determina se o ataque ou magia acerta o jogador, mas não reduz o dano recebido. Um jogador que usa escudo pode declarar a reação de \textbf{Bloqueio} para aumentar temporariamente sua Resistência com base nos atributos do escudo.
\end{rpgboxtips}

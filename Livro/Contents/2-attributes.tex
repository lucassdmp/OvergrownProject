...
Personagens atentos percebem o que outros ignoram: sons, mentiras, presenças invisíveis e pequenas aberturas na defesa. SEN é o atributo principal de ataques físicos à distância. Arcos, bestas, pistolas, rifles e outras armas de projétil usam \textbf{MOD de SEN no dano}, salvo quando a arma estiver sendo usada explicitamente como foco de uma magia. SEN também representa a capacidade de reorganizar os pensamentos e recuperar o foco durante uma Pausa Breve: seu MOD determina a recuperação de PC e, ao Meditar, de IEP.
...
\titlesection{Ritual de Ressonância}

A ligação entre um indivíduo e o Pináculo não é imutável. Utilizando uma \textbf{Lembrança do Passado}, o personagem pode desfazer temporariamente os caminhos formados por sua Energia de Divindade e remoldar sua conexão.

O ritual exige \textbf{oito horas ininterruptas fora de combate} e consome uma Lembrança do Passado. Ao concluí-lo, todos os Pontos de Talento gastos são devolvidos. O personagem deve então redistribuir esses pontos, respeitando o total correspondente à sua DIV e todos os pré-requisitos da árvore.

O ritual não altera DIV, Origem, perícias, conhecimentos adquiridos narrativamente, bênçãos, maldições, equipamentos ou habilidades concedidas por fontes externas à árvore.

Depois da redistribuição, recalcule HP, IEP, PC, Resistência, Esquiva, Movimento, Carga e MOD. Recursos atuais acima dos novos máximos são reduzidos ao máximo correspondente. O ritual não recupera recursos.

Equipamentos continuam equipados, mas um personagem que deixe de cumprir seus requisitos sofre normalmente as penalidades de uso inadequado. Uma Lembrança do Passado não permite guardar pontos de uma configuração anterior nem duplicar habilidades. Toda conexão anterior é desfeita antes da nova distribuição.

\begin{rpgboxtips}{Lembrança do Passado}
A Lembrança do Passado é um item físico, uma moeda de prata imbuída de Energia Primordial puríssima. Ela pode ser carregada, negociada, vendida ou comprada como qualquer outro artefato. Seu preço não é fixo: varia conforme disponibilidade, região, vendedor e demanda. A moeda é consumida quando o Ritual de Ressonância é concluído.
\end{rpgboxtips}

\begin{rpgboxtips}{Recompensas de Ascensão}
Ao alcançar \textbf{DIV 20, 40, 60, 80 e 100}, o aventureiro conquista o direito a uma Lembrança do Passado. A recompensa não aparece automaticamente no inventário. Para recebê-la, o aventureiro deve visitar a Guilda e acessar o Pináculo por meio da estrutura mantida pela organização, onde sua ascensão é reconhecida e a moeda é entregue.

Cada marco concede apenas uma Lembrança. O direito não expira caso o aventureiro demore para visitar a Guilda, mas uma moeda recebida, perdida, consumida ou negociada não é substituída gratuitamente. A Guilda registra quais recompensas de cada aventureiro já foram entregues.
\end{rpgboxtips}
...
O valor bruto de um atributo determina sua reserva de dados. O \textbf{Modificador de Atributo (MOD)} representa a parcela numérica usada em dano, recuperação e efeitos que pedem explicitamente um modificador. O MOD não é somado a testes de ataque, perícia ou salvaguarda. Ele só participa de uma rolagem quando a própria fórmula do efeito pedir explicitamente um MOD.
...
\begin{rpgboxtips}{MOD no Dano de Ataques}
Quando uma arma, magia ou Habilidade de Combate apresentar uma fórmula como \textbf{2D6 + MOD de MIG}, o MOD é somado somente à rolagem de dano, depois que o ataque acertar. Ele não aumenta o teste de acerto. Ataques físicos à distância constituem a regra geral específica: usam \textbf{MOD de SEN}. Se a fórmula de dano não escrever um MOD, nenhum Modificador de Atributo é acrescentado automaticamente.
\end{rpgboxtips}

...
\originlink{status:ardiloso} \pericia{Sangramento Ardiloso}{Dano contínuo por acúmulo. Para cada \textit{stack}, o alvo sofre $1D4 + \text{Grace/Wisdom}- \text{Fortitude}$. A remoção de cargas depende da sua robustez física:}

\pericia{Vulnerável}{O alvo perde sua Redução de Dano (Armadura) por uma rodada.}

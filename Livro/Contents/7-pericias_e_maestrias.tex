...
A maestria em uma perícia permite que o personagem realize feitos que ultrapassam a mera sorte, transformando esforço em resultados precisos. Cada perícia possui um \textbf{Atributo Base}: seu valor bruto determina a reserva de d20 do teste. Depois de conservar o resultado da reserva, some o bônus da Perícia. O Modificador de Atributo (MOD) não é somado ao teste.
...
\begin{center}
    ...
    \begin{tabularx}{\columnwidth}{@{} X r r @{}}
        ...
        IV \textit{(Mestre)}      & +20 & 40+ \\
        \bottomrule
    \end{tabularx}
\end{center}

\begin{rpgboxtips}{Exemplo de Evolução}
Um jogador começa com \textit{Luta} em Maestria I (+5). Antes de DIV 20, pode escolher outros avanços de Versatilidade ou Especialização, mas ainda não pode elevar \textit{Luta} acima desse limite. Ao atingir DIV 20, pode elevar \textit{Luta} para Maestria II (+10); em DIV 30, para Maestria III (+15); e em DIV 40, para Maestria IV (+20). Em um ataque corpo a corpo, um resultado 15 no maior d20 com Luta III (+15) produz um resultado final de ataque 30.
\end{rpgboxtips}

...
Ao concluir uma Pausa Breve válida, recupere PC igual a \textbf{1D4 por ponto do maior MOD entre MIG e GRA}. Depois, escolha uma das atividades:

\begin{itemize}
    \item \textbf{Recuperar o fôlego:} role \textbf{2D8}; atribua um resultado à recuperação de HP e o outro à recuperação de IEP.
    \item \textbf{Meditar:} não role os 2D8. Recupere \textbf{1D6 de IEP por ponto do MOD de WIS}; esta atividade não recupera HP.
\end{itemize}

Nenhuma recuperação pode ultrapassar o máximo do recurso. Um atributo com MOD 0 não concede dados. As rolagens de uma mesma fonte são feitas em conjunto: MOD 3 concede 3D4 PC ou, ao meditar com MOD de WIS 3, 3D6 IEP.

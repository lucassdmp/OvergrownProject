...
\textbf{\ringmfamily Lorde atual:} Tiberius   III, um estrategista obcecado por inovação bélica. Mantém segredo sobre um projeto de "armas trovejantes" que rivalizam com a pólvora de grandes bombas.
...
\titlesection{Terras Vastas – Vastidrum}
...
\titlesection{Terras Gélidas – Nostradum}
...
\titlesection{Terras Glaciais – Glastradum}
...
\subsection*{Frostheaven, O Porto das Almas Perdidas – \textit{"O local onde pessoas vão para serem esquecidas"}}
...
\titlesection{Terras Tempestuosas – Sorodrum}

...
\pericia{Controlado}{A vontade do alvo é completamente suprimida. O personagem \textbf{executa qualquer ordem} de quem o controla, incluindo atacar aliados, revelar segredos ou se colocar em perigo, exceto ordens de suicídio imediato e óbvio. Diferente de \textbf{Encantado}, o alvo controlado não tem autonomia: age como um instrumento direto do controlador. Exige um teste de \link{att:sense}{Sense} no início de cada turno (DT definida pela fonte do efeito) para tentar se libertar.}
...
\pericia{Encantado}{O encantamento embaralha a percepção do alvo sobre a fonte do efeito. O alvo \textbf{não pode atacar voluntariamente} quem o encantou e tende a agir com neutralidade ou simpatia em relação a ele, mas mantém sua autonomia de ação para tudo mais. Exige um teste de \link{att:sense}{Sense} (DT definida pela fonte) para resistir inicialmente; nas rodadas seguintes, o alvo pode repetir o teste no início de cada turno para quebrar o efeito.}

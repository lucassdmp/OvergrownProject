...
Resistência reduz dano de ataques diretos. É diretamente baseada também na \link{att:fortitude}{Fortitude} do jogador. A cada 2 Pontos de Fortitude o jogador ganha 1 ponto de Resistência, e logo 1 de redução de ataques diretos. Um jogador com 20 pontos de Fortitude terá 10 de redução de dano, excluindo bônus e reduções provenientes da da árvore de talentos e de itens equipados.

\begin{rpgboxtips}{Bloqueio da Resistência}
A redução de dano proveniente da Resistência só é aplicada se o alvo do ataque decidir bloquear, em caso de esquivas e falha, apenas redução de danos nativas são contabilizadas. Bloqueio não conta como reação.
\end{rpgboxtips}
